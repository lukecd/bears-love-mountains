...
const Info: React.FC<InfoProps> = ({ id, mainColor, accentColor }) => {
	...
	switch (id) {
		...
		case 3:
			content = (
				<div style={style} className="lexend-mega-300 flex flex-col w-1/4 justify-center items-start p-3">
		...
		case 4:
			content = (
				<div style={style} className="lexend-mega-300 flex flex-col w-1/4 justify-end items-end p-3">
		...
		case 5:
			content = (
				<div style={style} className="lexend-mega-300 flex flex-col w-1/4 justify-center items-center p-3">
